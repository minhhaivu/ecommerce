 ...
 */
public class CustomizedEmailableReporter implements IReporter {
    private static final Logger LOG = Logger.getLogger(CustomizedEmailableReporter.class);
    ...
    private String fileName = "customized-emailable-report.html";
    ...
    protected void writeHead() {
        ...
        writer.println("<title>Customized TestNG Report</title>");
        writeStylesheet();
        writer.println("</head>");
    }
    ...
    protected void writeScenarioSummary() {
        ...
        for (SuiteResult suiteResult : suiteResults) {
            ...
            for (TestResult testResult : suiteResult.getTestResults()) {
                ...
                scenarioIndex +=
                        writeScenarioSummary(
                                testName + " &#8212; failed (getConfiguration methods)",
        ...
        if (!classResults.isEmpty()) {
            ...
            for (ClassResult classResult : classResults) {
                ...
                for (MethodResult methodResult : classResult.getMethodResults()) {
                    ...
                    Date start = firstResult.getTestContext().getStartDate();
                    long duration = firstResult.getEndMillis() - firstResult.getStartMillis();
